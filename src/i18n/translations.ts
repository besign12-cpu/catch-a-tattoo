...
const translations = {
  en: {
    ...
    discover: {
      ...
      addGuestWork: "Add Guest Work",
      registerGuestWork: "Add Guest Work",
      pageTitle: "Add Guest Work",
    ...
    schedule: {
      step1Title: "Which city are you going to?",
      step1Desc: "Search by city or country name",
      step1Label: "Select city",
      step1Next: "{city} selected",
      step1Placeholder: "Select a city",
      step2Title: "{city} Overview",
      step2CurrentGuest: "Current Guest",
      step2BringDemand: "Bring Demand",
      step2Banner: "Demand data coming soon",
      step2BannerDesc: "Real-time Bring demand and Guest stats will be connected soon.",
      step2Next: "Select Dates",
      step3Title: "Select dates",
      step3StartDate: "Start",
      step3EndDate: "End",
      step3ExistingSchedule: "Existing schedule",
      step3Title2: "Select Dates",
      step3Next: "Dates selected",
      step3NextDisabled: "Please select start and end dates",
      step4Title: "{city} during that period",
      step4GuestCount: "{count} Guest artists",
      step5Title: "Details",
      step5ContactMethod: "Contact Method",
      step5Contact: "Contact",
      step5Note: "Note",
      step5NoteOptional: "(optional)",
      step5NotePlaceholder: "Available spots, studio location, etc.",
      step5Submit: "Register Guest Work",
      step5Submitting: "Registering...",
  ...
  ko: {
    ...
    discover: {
      ...
      registerGuestWork: "Guest Work 등록",
      pageTitle: "Guest Work 등록",
    ...
    schedule: {
      step1Title: "어느 도시로 가나요?",
      step1Desc: "도시명 또는 국가명으로 검색하세요",
      step1Label: "도시 선택",
      step1Next: "{city} 선택 완료",
      step1Placeholder: "도시를 선택해주세요",
      step2Title: "{city} 현황",
      step2CurrentGuest: "현재 Guest",
      step2BringDemand: "Bring 수요",
      step2Banner: "수요 데이터 연결 예정",
      step2BannerDesc: "실제 Bring 수요와 Guest 현황이 곧 연결됩니다. 지금은 일정 등록을 계속 진행해주세요.",
      step2Next: "날짜 선택하기",
      step3Title: "날짜를 선택하세요",
      step3StartDate: "시작일",
      step3EndDate: "종료일",
      step3ExistingSchedule: "이미 등록된 일정",
      step3Title2: "날짜를 선택해주세요",
      step3Next: "날짜 선택 완료",
      step3NextDisabled: "시작일과 종료일을 선택해주세요",
      step4Title: "해당 기간 {city}",
      step4GuestCount: "Guest {count}명",
      step5Title: "상세 정보",
      step5ContactMethod: "연락 방법",
      step5Contact: "연락처",
      step5Note: "메모",
      step5NoteOptional: "(선택)",
      step5NotePlaceholder: "예약 가능 자리 수, 스튜디오 위치 등",
      step5Submit: "Guest Work 등록 완료",
      step5Submitting: "등록 중...",
      prevStep: "이전 단계",
      prevMonth: "이전 달",
      nextMonth: "다음 달",
    },
